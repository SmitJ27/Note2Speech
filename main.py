...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # read func
        read_button = QPushButton("Read the Text")
        read_button.setToolTip("Read the text in the editor")
        read_button.clicked.connect(self.read_text)
    ...
    def read_text(self):
        ...
        # Use a text-to-speech engine to read the text
        engine = pyttsx3.init()
        engine.say(text)
        engine.runAndWait()

    # read func function end
    ...
    def update_title(self):
        ...
        # rename it as Note2Speech
        self.setWindowTitle("%s - Note2Speech" %(os.path.basename(self.path)
...
if __name__ == '__main__':
    ...
    app.setApplicationName("Note2Speech")
